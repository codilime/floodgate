 ...
 * @param optional nil or *DeletePinUsingDELETEOpts - Optional Parameters:
     * @param "Reference" (optional.String) -  reference


*/

type DeletePinUsingDELETEOpts struct {
	Reference optional.String
}

func (a *ManagedControllerApiService) DeletePinUsingDELETE(ctx context.Context, application string, targetEnvironment string, localVarOptionals *DeletePinUsingDELETEOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param application application
 * @param optional nil or *GetApplicationDetailsUsingGETOpts - Optional Parameters:
 ...
 * @param optional nil or *GetConstraintStateUsingGETOpts - Optional Parameters:
