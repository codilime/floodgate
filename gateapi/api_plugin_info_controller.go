 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *GetAllPluginInfoUsingGETOpts - Optional Parameters:
     * @param "Service" (optional.String) -  service

@return []interface{}
*/

type GetAllPluginInfoUsingGETOpts struct { 
	Service optional.String
}

func (a *PluginInfoControllerApiService) GetAllPluginInfoUsingGET(ctx context.Context, localVarOptionals *GetAllPluginInfoUsingGETOpts) ([]interface{}, *http.Response, error) {
	var (
